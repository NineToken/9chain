#############################################################################
# Makefile for building: 9token-qt
# Generated by qmake (3.1) (Qt 5.12.2)
# Project:  9token-qt.pro
# Template: app
# Command: /opt/buildWallet/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5 -o Makefile 9token-qt.pro BOOST_LIB_SUFFIX=-mt BOOST_THREAD_LIB_SUFFIX=_win32-mt BOOST_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include/boost BOOST_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib OPENSSL_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include/openssl OPENSSL_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib BDB_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include BDB_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib MINIUPNPC_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include MINIUPNPC_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib USE_QRCODE=1 QMAKE_LRELEASE=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/qt5/bin/lrelease
#############################################################################
...
QMAKE         = /opt/buildWallet/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /opt/buildWallet/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5 -install qinstall
QINSTALL_PROGRAM = /opt/buildWallet/mxe/usr/bin/i686-w64-mingw32.static-qmake-qt5 -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
Makefile: 9token-qt.pro ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/win32-g++/qmake.conf ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile 9token-qt.pro BOOST_LIB_SUFFIX=-mt BOOST_THREAD_LIB_SUFFIX=_win32-mt BOOST_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include/boost BOOST_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib OPENSSL_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include/openssl OPENSSL_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib BDB_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include BDB_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib MINIUPNPC_INCLUDE_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/include MINIUPNPC_LIB_PATH=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/lib USE_QRCODE=1 QMAKE_LRELEASE=/opt/buildWallet/mxe/usr/i686-w64-mingw32.static/qt5/bin/lrelease
...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /opt/buildWallet/9token/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /opt/buildWallet/9token/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /opt/buildWallet/9token/9token-qt_plugin_import.cpp .qmake.stash

/opt/buildWallet/9token/src/leveldb/libleveldb.a: FORCE
