...
const string strMessageMagic = "9TOKEN Signed Message:\n";
...
// miner's coin base reward premine -- Premined:899.999.999
int64_t GetProofOfWorkReward(int64_t nFees)
{
        int64_t nSubsidy = 1 * COIN;
        
        if (pindexBest->nHeight+1 < 2)
            nSubsidy = 899999999 * COIN;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // 9TOKEN: check proof-of-stake block signature
...
// 9TOKEN: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "9TOKEN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "9TOKEN Block";
        CTransaction txNew;
        txNew.nTime = 1578889800;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1578889800;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2660395;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x277be644d9de30754da26ae128fa81e321981f6e6824133478a602fc3110a2f1"));
        block.print();
